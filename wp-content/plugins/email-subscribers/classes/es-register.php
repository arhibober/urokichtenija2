...
class es_cls_registerhook {
	...
	public static function es_load_widget_scripts_styles() {
		...
		$es_select_params = array(
			...
			'es_success_notice'  => _x( 'Поздравляем, Ваш аккаунт успешно создан! Ссылка на активизацию пришла на Ваш e-mail. Если письмо не получено - проверьте, возможно, оно находится в спаме!', 'widget-page-enhanced-select', 'email-subscribers' ),
